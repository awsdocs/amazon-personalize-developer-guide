...
## Identity\-based policies for Amazon Personalize<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for Amazon Personalize<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within Amazon Personalize<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for Amazon Personalize<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for Amazon Personalize<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for Amazon Personalize<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## ACLs in Amazon Personalize<a name="security_iam_service-with-iam-acls"></a>
...
## ABAC with Amazon Personalize<a name="security_iam_service-with-iam-tags"></a>
...
## Cross\-service principal permissions for Amazon Personalize<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for Amazon Personalize<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for Amazon Personalize<a name="security_iam_service-with-iam-roles-service-linked"></a>
