...
+ [Domain dataset groups](domain-dataset-groups.md)
   ...
   + [Creating recommenders](creating-recommenders.md)
      + [Choosing recommender use cases](domain-use-cases.md)
         + [VIDEO_ON_DEMAND use cases](VIDEO_ON_DEMAND-use-cases.md)
   ...
   + [Managing Domain dataset group resources](managing-domain-resources.md)
      ...
      + [Managing recommenders](managing-recommenders.md)
         + [Stopping and starting a recommender](stopping-starting-recommender.md)
...
+ [Custom dataset groups](custom-dataset-groups.md)
   ...
   + [Creating a solution](training-deploying-solutions.md)
      + [Step 1: Choosing a recipe](working-with-predefined-recipes.md)
         ...
         + [POPULAR_ITEMS](popularity-recipes.md)
